...
var core = __toESM(require("ag-charts-core"));
...
// packages/ag-charts-community/src/util/object.ts
var { entries, isArray, isObject, isPlainObject } = core;
...
function SceneArrayChangeDetection(opts) {
  const baseOpts = opts ?? {};
  baseOpts.equals = import_ag_charts_core2.arraysEqual;
  return SceneChangeDetection(opts);
}
...
var _Node = class _Node {
  constructor(options) {
    ...
    this.id = (0, import_ag_charts_core3.createId)(this);
    this.name = void 0;
  ...
  static toSVG(node, width, height) {
    ...
    if (svg == null || !svg.elements.length && !svg.defs?.length)
      return;
    const root = (0, import_ag_charts_core3.createSvgElement)("svg");
    root.setAttribute("width", String(width));
    root.setAttribute("height", String(height));
    root.setAttribute("viewBox", `0 0 ${width} ${height}`);
    if (svg.defs?.length) {
      const defs = (0, import_ag_charts_core3.createSvgElement)("defs");
  ...
  isolatedRender(renderCtx) {
    ...
    try {
      ...
      import_ag_charts_core3.Logger.warnOnce("Error during rendering", e, e.stack);
    } finally {
...
var logTimeGap = () => {
  ...
  if (timeSinceLastLog > LONG_TIME_PERIOD_THRESHOLD) {
    ...
    import_ag_charts_core4.Logger.log(`**** ${prettyDuration}s since last log message ****`);
  }
...
var Debug = {
  create(...debugSelectors) {
    const resultFn = (...logContent) => {
      if (Debug.check(...debugSelectors)) {
        if (typeof logContent[0] === "function") {
          logContent = (0, import_ag_charts_core4.toArray)(logContent[0]());
        }
        logTimeGap();
        import_ag_charts_core4.Logger.log(...logContent);
      }
    };
    return Object.assign(resultFn, {
      ...
      group: (name, cb) => {
        if (Debug.check(...debugSelectors)) {
          return import_ag_charts_core4.Logger.logGroup(name, cb);
        }
        return cb();
      }
    });
  ...
  check(...debugSelectors) {
    ...
    const chartDebug = (0, import_ag_charts_core4.toArray)((0, import_ag_charts_core4.getWindow)("agChartsDebug"));
...
var _Color = class _Color {
  ...
  constructor(r, g, b, a = 1) {
    this.r = (0, import_ag_charts_core5.clamp)(0, r || 0, 1);
    this.g = (0, import_ag_charts_core5.clamp)(0, g || 0, 1);
    this.b = (0, import_ag_charts_core5.clamp)(0, b || 0, 1);
    this.a = (0, import_ag_charts_core5.clamp)(0, a || 0, 1);
  }
  /**
  ...
  static stringToRgba(str) {
    ...
    for (let i = 0; i < parts.length; i++) {
      ...
      if (part.indexOf("%") >= 0) {
        value = (0, import_ag_charts_core5.clamp)(0, value, 100);
        value /= 100;
      } else if (i === 3) {
        value = (0, import_ag_charts_core5.clamp)(0, value, 1);
      } else {
        value = (0, import_ag_charts_core5.clamp)(0, value, 255);
        value /= 255;
      }
      rgba.push(value);
    }
  ...
  static lighten(c, t) {
    ...
    return _Color.fromOKLCH((0, import_ag_charts_core5.clamp)(0, oklch[0] + t, 1), oklch[1], oklch[2]);
  }
  static darken(c, t) {
    const oklch = _Color.RGBtoOKLCH(c.r, c.g, c.b);
    return _Color.fromOKLCH((0, import_ag_charts_core5.clamp)(0, oklch[0] - t, 1), oklch[1], oklch[2]);
...
var BaseProperties = class {
  ...
  set(properties) {
    ...
    if (typeof properties !== "object") {
      import_ag_charts_core11.Logger.warn(`unable to set ${className} - expecting a properties object`);
      return this;
    }
        ...
        if (isProperties(self[propertyKey])) {
          if (self[propertyKey] instanceof PropertiesArray) {
            ...
            if (array != null) {
              ...
              import_ag_charts_core11.Logger.warn(`unable to set [${propertyKey}] - expecting a properties array`);
            }
          } else {
            self[propertyKey].set(value);
          }
        } else if ((0, import_ag_charts_core11.isPlainObject)(value)) {
    ...
    for (const unknownKey of keys) {
      import_ag_charts_core11.Logger.warn(`unable to set [${unknownKey}] in ${className} - property is unknown`);
    }
    return this;
  }
  toJson() {
...
var PropertiesArray = class _PropertiesArray extends Array {
  ...
  set(properties) {
    if ((0, import_ag_charts_core11.isArray)(properties)) {
...
function bezier2DDistance(cp0x, cp0y, cp1x, cp1y, cp2x, cp2y, cp3x, cp3y, x, y, precision = 1) {
  ...
  while (queue != null) {
    ...
    queue = (0, import_ag_charts_core15.insertListItemsSorted)(queue, newCandidates, bezierCandidateCmp);
  }
...
var core2 = __toESM(require("ag-charts-core"));
var { isArray: isArray3, isObject: isObject2 } = core2;
...
__decorateClass([
  SceneChangeDetection({ convertor: (v) => (0, import_ag_charts_core18.clamp)(0, v ?? 1, 1) })
...
__decorateClass([
  SceneObjectChangeDetection({ equals: import_ag_charts_core18.boxesEqual, changeCb: (s) => s.onFillChange() })
...
var _Text = class _Text extends Shape {
  ...
  render(renderCtx) {
    ...
    const lineOriginY = textBaseline === "alphabetic" ? 0 : -TextUtils.getVerticalModifier(textBaseline) * lineHeight * (lines - 1);
  ...
  setFont(props) {
    ...
    this.fontSize = props.fontSize ?? _Text.defaultFontSize;
  ...
  toSVG() {
    if (!this.visible || !this.text)
      return;
    const element = (0, import_ag_charts_core23.createSvgElement)("text");
...
__decorateClass([
  SceneChangeDetection({
    convertor: (value) => (0, import_ag_charts_core23.isDefined)(value) ? String(value) : value,
...
var Path = class extends Shape {
  ...
  toSVG() {
    if (!this.visible)
      return;
    const element = (0, import_ag_charts_core26.createSvgElement)("path");
...
var HdpiCanvas = class {
  constructor(options) {
    ...
    this.pixelRatio = options.pixelRatio ?? (0, import_ag_charts_core31.getWindow)("devicePixelRatio") ?? 1;
    this.element = canvasElement ?? (0, import_ag_charts_core31.createElement)("canvas");
...
var ImageLoader = class extends import_ag_charts_core32.EventEmitter {
  constructor() {
    super(...arguments);
...
// packages/ag-charts-community/src/scene/scene.ts
var Scene = class extends import_ag_charts_core33.EventEmitter {
  constructor(canvasOptions) {
    super();
    this.debug = Debug.create(true, "scene" /* SCENE */);
    this.id = (0, import_ag_charts_core33.createId)(this);
    this.imageLoader = new ImageLoader();
    this.root = null;
    this.pendingSize = null;
    this.isDirty = false;
    this.cleanup = new import_ag_charts_core33.CleanupRegistry();
    ...
    this.cleanup.register(
      ...
      this.imageLoader.on("image-error", ({ uri }) => {
        import_ag_charts_core33.Logger.warnOnce(`Unable to load image ${uri}`);
      })
    );
  }
  waitingForUpdate() {
  ...
  download(fileName, fileFormat) {
    (0, import_ag_charts_core33.downloadUrl)(this.canvas.toDataURL(fileFormat), fileName?.trim() ?? "image");
  }
...
var Arc = class extends Path {
  ...
  get fullPie() {
    return (0, import_ag_charts_core34.isNumberEqual)(normalizeAngle360(this.startAngle), normalizeAngle360(this.endAngle));
  }
  updatePath() {
...
var Line = class extends Shape {
  ...
  toSVG() {
    if (!this.visible)
      return;
    const element = (0, import_ag_charts_core35.createSvgElement)("line");
...
var RadialColumnShape = class extends Path {
  ...
  updateBeveledPath() {
    ...
    const isStackBottom = (0, import_ag_charts_core36.isNumberEqual)(innerRadius, axisInnerRadius);
    ...
    const isEmpty = (0, import_ag_charts_core36.isNumberEqual)(innerRadius, outerRadius);
    ...
    if (isEmpty && shouldConnectBottomCircle) {
      ...
      if (!(0, import_ag_charts_core36.isNumberEqual)(topIntersectionX, 0)) {
...
__decorateClass([
  SceneObjectChangeDetection({ equals: import_ag_charts_core37.boxesEqual })
