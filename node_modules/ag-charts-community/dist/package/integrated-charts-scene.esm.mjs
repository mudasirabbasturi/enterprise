...
import { Logger as Logger9, getWindow as getWindow2, isString, toArray as toArray2 } from "ag-charts-core";
...
import { boxesEqual as boxesEqual2, clamp as clamp4, generateUUID } from "ag-charts-core";
...
var BaseProperties = class {
  ...
  set(properties) {
        ...
        if (isProperties(self[propertyKey])) {
          if (self[propertyKey] instanceof PropertiesArray) {
            ...
            if (array != null) {
              ...
              Logger4.warn(`unable to set [${propertyKey}] - expecting a properties array`);
            }
          } else {
    ...
    for (const unknownKey of keys) {
      Logger4.warn(`unable to set [${unknownKey}] in ${className} - property is unknown`);
    }
    return this;
  }
  toJson() {
...
import * as core2 from "ag-charts-core";
...
import { Logger as Logger11, clamp as clamp9, countFractionDigits, createNumberFormatter, parseNumberFormat } from "ag-charts-core";
...
function tickStep(start, end, count, minCount = 0, maxCount = Infinity) {
  if (start === end) {
    return clamp9(1, minCount, maxCount);
  } else if (count < 1) {
    return NaN;
  }
