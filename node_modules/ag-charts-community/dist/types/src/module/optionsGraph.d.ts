 ...
 */
export declare class OptionsGraph extends core.AdjacencyListGraph<unknown, string> implements OptionsGraphInterface {
    ...
    constructor(config?: PlainObject, userOptions?: PlainObject, params?: PlainObject, palette?: PlainObject, overrides?: PlainObject, internalParams?: Map<any, any>);
    clear(): void;
    resolve(): PlainObject;
    ...
    resolveVertexValue(vertex: Vertex<unknown>, valueVertex: Vertex<unknown>): any;
