...
export declare abstract class Chart extends Observable implements ModuleInstance, ChartService {
    ...
    getOptions(): import("ag-charts-types").AgCartesianChartOptions<any, unknown> | import("ag-charts-types").AgPolarChartOptions<any, unknown> | import("ag-charts-types").AgHierarchyChartOptions<any, unknown> | import("ag-charts-types").AgTopologyChartOptions<any, unknown> | import("ag-charts-types").AgFlowProportionChartOptions<any, unknown> | import("ag-charts-types").AgStandaloneChartOptions<any, unknown>;
