...
export declare class ScatterSeriesProperties extends CartesianSeriesProperties<AgScatterSeriesOptions> {
    ...
    readonly tooltip: import("../seriesTooltip").SeriesTooltip<Omit<AgScatterSeriesTooltipRendererParams<any, unknown>, "context">>;
    readonly marker: SeriesMarker<AgScatterSeriesOptionsKeys<any>>;
}
export {};
