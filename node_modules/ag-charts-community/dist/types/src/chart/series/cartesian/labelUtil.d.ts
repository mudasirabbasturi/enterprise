...
export declare function updateLabelNode(textNode: Text, label: Pick<Label, 'enabled' | 'color' | 'fontStyle' | 'fontWeight' | 'fontSize' | 'fontFamily'>, labelDatum?: LabelDatum): void;
