...
import type { AgChartLabelFormatterParams, AgInitialStateLegendOptions, AgSeriesMarkerStyle, AgSeriesTooltipRendererParams, AgSeriesVisibilityChange, FormatterPropertyType, ISeriesMarker } from 'ag-charts-types';
...
export declare abstract class Series<TDatumIndex, TDatum extends SeriesNodeDatum<TDatumIndex>, TProps extends SeriesProperties<any>, TLabel = TDatum, TContext extends SeriesNodeDataContext<TDatumIndex, TDatum, TLabel> = SeriesNodeDataContext<TDatumIndex, TDatum, TLabel>> extends Observable implements ISeries<TDatumIndex, TDatum, TProps, TLabel> {
    ...
    protected getHighlightState(isHighlight?: boolean, datumIndex?: TDatumIndex, legendItemValues?: string[]): HighlightState;
    protected isSeriesHighlighted(highlightedDatum?: HighlightNodeDatum, _legendItemValues?: string[]): boolean;
    protected isItemHighlighted(highlightedDatum?: HighlightNodeDatum, datumIndex?: TDatumIndex): boolean | undefined;
    protected getHighlightStyle(isHighlight?: boolean, datumIndex?: TDatumIndex, legendItemValues?: string[]): Partial<any>;
    ...
    protected updateMarkerStyle<TParams>(marker: ISeriesMarker<TParams & {
        ...
        size?: number;
        focusSize?: number;
    } | undefined, params: TParams & {
        context?: never;
    }, highlighted: boolean, defaultStyle: AgSeriesMarkerStyle, fillBBox?: ShapeFillBBox, { applyTranslation, selected }?: {
