import type { AgAxisLabelFormatterParams, AgAxisLabelStylerParams, AgBaseAxisLabelStyleOptions, AgCartesianAxisPosition, FontOptions, Formatter, FormatterParams, Styler, TextWrap } from 'ag-charts-types';
...
export interface ChartAxis {
    ...
    formatDatum<Params extends object>(value: any, source: 'crosshair' | 'annotation-label', seriesId: undefined, legendItemName: undefined, datum: undefined, key: undefined, domain: undefined, label: AxisFormattableLabel<Params>, params: Params, formatInContext: ContextFormatter<Params>): string;
    formatDatum<Params extends object>(value: any, source: 'tooltip' | 'series-label', seriesId: string, legendItemName: string | undefined, datum: any, key: string, domain: any[], label: AxisFormattableLabel<Params>, params: Params, formatInContext: ContextFormatter<Params>): string;
    getBBox(): BBox;
