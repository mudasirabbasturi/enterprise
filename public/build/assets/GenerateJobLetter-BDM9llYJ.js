import{r,j as t,E as v,S as w}from"./vendor-react-C2xqwMw4.js";import{C as j}from"./app-Bf4ugdt9.js";import{aY as x}from"./vendor-Ca2vlWXu.js";import"./vendor-tinymce-LaId0j-P.js";import"./vendor-inertia-DLoN6V7S.js";import"./vendor-chart-DwXpjXxm.js";import"./vendor-antd-DojYAy1L.js";const Y=r.forwardRef(({data:n,onClose:u,setParentLoading:o},d)=>{const p=j(),i=new Date,f=`${i.getMonth()+1}/${i.getDate()}/${i.getFullYear()}`,l=r.useMemo(()=>`
      ...
      `,[]),[h,a]=r.useState(!1),[_,b]=r.useState({job_letter_content:l}),c=r.useRef(null),g=(e,m)=>{b(s=>({...s,[e]:m}))},y=async()=>{a(!0),o==null||o(!0);try{const e=c.current;if(!e)throw new Error("PDF element not found");e.style.overflow="visible";const s=(await x(e,{scale:2,logging:!1,useCORS:!0,allowTaint:!0,scrollX:0,scrollY:0})).toDataURL("image/png",1);w.put(p("generate.jobletter",n.id),{..._,image:s},{preserveScroll:!0,onSuccess:()=>u(),onError:()=>a(!1),onFinish:()=>a(!1)})}catch(e){console.error("Error generating job letter:",e)}finally{a(!1),o==null||o(!1)}};return r.useImperativeHandle(d,()=>({submitForm:y})),t.jsx("div",{className:"container-fluid",children:t.jsxs("div",{className:"row",children:[t.jsx("div",{className:"col-md-6 col-12 m-0 p-0",children:t.jsx(v,{initialValue:l,onEditorChange:e=>{g("job_letter_content",e)},disabled:h,init:{height:"100%",menubar:!1,plugins:"table code lists link",toolbar:"undo redo | formatselect | bold italic | alignleft aligncenter alignright | bullist numlist | link | table | code",block_formats:"Paragraph=p; Heading 1=h1; Heading 2=h2; Heading 3=h3",skin:!1,content_css:!1,content_style:`
                ...
                `,font_family_formats:"Adobe Clean Regular=Adobe Clean Regular, sans-serif"}})}),t.jsx("div",{className:"col-md-6 col-12 border p-1 rounded",ref:c,children:t.jsx("div",{className:"p-5",children:t.jsx("div",{dangerouslySetInnerHTML:{__html:_.job_letter_content}})})})]})})});export{Y as default};
