import{r as n,C as w,j as t,S as j}from"./app-HbSpJPac.js";import{h as x}from"./html2canvas.esm-BfYXEYrK.js";import{E as k}from"./Editor-CQAP8ZkP.js";import"./skin-DY8BMAJN.js";const D=n.forwardRef(({data:o,onClose:u,setParentLoading:r},p)=>{const f=w(),l=new Date,h=`${l.getMonth()+1}/${l.getDate()}/${l.getFullYear()}`,_=n.useMemo(()=>`
