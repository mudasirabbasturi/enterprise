import{r,C as v,j as t,S as w}from"./app-CNd5r2V9.js";import{h as j}from"./html2canvas.esm-BfYXEYrK.js";import{E as x}from"./Editor-C3ZNyr-l.js";import"./skin-DY8BMAJN.js";const D=r.forwardRef(({data:n,onClose:u,setParentLoading:o},d)=>{const p=v(),i=new Date,f=`${i.getMonth()+1}/${i.getDate()}/${i.getFullYear()}`,l=r.useMemo(()=>`
