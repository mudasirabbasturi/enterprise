...
class DesignationPolicy
{
    ...
    {
        return $user->hasPermission('Designation', 'View Designation');
    }
    ...
    {
        return $user->hasPermission('Designation', 'Create Designation');
    }
    ...
    {
        return $user->hasPermission('Designation', 'Update Designation');
    }
    ...
    {
        return $user->hasPermission('Designation', 'Delete Designation');
    }
