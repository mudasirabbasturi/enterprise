          ...
          <div className="col-6">
            ...
            <div>
              ...
              <div className="d-flex align-items-center mb-3">
                ...
                <Input
                  ...
                  value={selectedProject.project_pricing}
                />
                <label
                  className="me-1"
                  style={{ whiteSpace: "nowrap" }}
              ...
              <div className="d-flex align-items-center mb-3">
                ...
                <Select
                  ...
                  // }))}
                  // disabled={loading}
                  value={selectedProject.project_construction_type}
                  options={[
                ...
                <Input
                  ...
                  value={selectedProject.project_template}
                />
              </div>
              <div className="d-flex align-items-center mb-3">
                <label
                ...
                <Input
                  ...
                  value={selectedProject.project_line_items_pricing}
                />
                <label
                ...
                <Input
                  ...
                  value={selectedProject.project_floor_number}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="d-flex align-items-center mb-3">
                ...
                <Input
                  className="me-1"
                  placeholder="Add Project Initial Link"
                  value={selectedProject.project_init_link}
                />
                <label
                ...
                <Input
                  placeholder="Add Project Final Link"
                  value={selectedProject.project_final_link}
                />
              </div>
            </div>
            {/* Projects Links End */}
            ...
            <div>
              ...
              <div className="d-flex align-items-center mb-3">
                ...
                <Input
                  className="me-1"
                  placeholder="Project Started Date"
                ...
                <Input
                  ...
                  value={selectedProject.actual_start_date}
                />
              </div>
              <div className="d-flex align-items-center mb-3">
                <label
                ...
                <Input
                  ...
                  value={selectedProject.project_duration}
                />
                <label
                ...
                <Input
                  className="me-1"
                  placeholder="Add Total Duration Taken"
                  value={selectedProject.actual_duration}
                />
              </div>
              <div className="d-flex align-items-center mb-3">
                <label
                ...
                <Input
                  ...
                  value={selectedProject.project_due_date}
                />
                <label
                  ...
                  style={{ whiteSpace: "nowrap" }}
                >
                  Completed At:<hr className="m-0"></hr>
                </label>
                <Input
                  className="me-1"
                  placeholder="Project Completed At"
                  value={selectedProject.actual_end_date}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="d-flex align-items-center mb-3">
                ...
                <Input
                  ...
                  value={selectedProject.budget_total}
                />
                <label
                  htmlFor="tax_amount"
                  className="me-1"
                ...
                <Input
                  ...
                  value={selectedProject.tax_amount}
                />
              </div>
              <div className="d-flex align-items-center mb-3">
                <label
                ...
                <Input
                  ...
                  value={selectedProject.discount_amount}
                />
                <label
                ...
                <Input
                  ...
                  value={selectedProject.deduction_amount}
                />
              </div>
              <div className="d-flex align-items-center mb-3">
                <label
                ...
                <Input
                  ...
                  value={selectedProject.price_final}
                />
                <label
                  htmlFor="amount_paid"
                  className="me-1"
                ...
                <Input
                  ...
                  value={selectedProject.amount_paid}
                />
              </div>
              <div className="d-flex align-items-center mb-3">
                <label
                ...
                <Input
                  ...
                  value={selectedProject.amount_due}
                />
                <label
                ...
                <Input
                  ...
                  value={selectedProject.amount_received}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="d-flex align-items-center mb-3">
                ...
                <Input
                  ...
                  value={selectedProject.project_points}
                />
              </div>
              <div className="d-flex align-items-center mb-3">
                <label
                ...
                <Input
                  placeholder="Preview Status"
                  value={selectedProject.preview_status}
                />
              </div>
            </div>
            {/* Points & Status End */}
