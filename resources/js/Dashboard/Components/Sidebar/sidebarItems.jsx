...
export const getSidebarItems = ({
  ...
  return [
    ...
    //       key: "salary-setup",
    //       label: (
    //         <Link href={route("")}>Salary Setup</Link>
    //       ),
    //       icon: <CheckCircleOutlined />,
    //     },
    //     {
    //       key: "salary-sheets",
    //       label: (
    //         <Link href={route("")}>Salary Sheets</Link>
    //       ),
    //       icon: <CheckCircleOutlined />,
    //     },
    //     {
    //       key: "tax-management",
    //       label: (
    //         <Link href={route("")}>Tax Management</Link>
    //       ),
    //       icon: <CheckCircleOutlined />,
    //     },
    //     {
    //       key: "salary-packages",
    //       label: (
    //         <Link href={route("")}>Salary Packages</Link>
    //       ),
    //       icon: <CheckCircleOutlined />,
    //     },
    //     {
    ...
    //       label: (
    //         <Link href={route("")}>Penalty Management</Link>
    //       ),
    //       icon: <CheckCircleOutlined />,
    //     },
    //   ],
