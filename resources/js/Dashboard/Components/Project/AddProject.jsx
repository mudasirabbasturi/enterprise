...
const AddProject = forwardRef(({ onClose, clients, setParentLoading }, ref) => {
            ...
            <div>
              ...
              <div className="d-flex align-items-center mb-3">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    onChangeValue("project_line_items_pricing", e.target.value)
                  }
                  disabled={loading}
                />
                <label
            ...
            <div>
              ...
              <div className="d-flex align-items-center mb-3">
                ...
                <Select
                  ...
                  onChange={(project_status) =>
                    onChangeValue("project_status", project_status ?? "Pending")
                  }
                  disabled={loading}
                />
              </div>
              <div className="d-flex align-items-center mb-3">
                ...
                <Select
                  ...
                  allowClear={values.project_source !== "active"}
                  showSearch
                  options={[
