...
const Index = ({ branches }) => {
  ...
  useEffect(() => {
    ...
    // channel.listen(".branch-created", (data) => {
    ...
    // return () => channel.stopListening(".branch-created");
  ...
  // useEffect(() => {
  //   const channel = window.Echo.channel("my-channel");
  //   channel.listen(".branch-created", () => {
  //     alert("branch created");
  //     router.get(route("branch.index"), {
  //       onSuccess: (page) => setRowData(page.props.branches),
  //     });
  //   });
  //   return () => channel.stopListening(".branch-created");
  // }, []);
